...
var lessc_helper = {
    ...
    printUsage: function() {
        ...
        console.log("  --clean-less              Compress output using clean-less");
        console.log("  --clean-option=opt:val   Pass an option to clean less, using CLI arguments from ");
        console.log("                           https://github.com/GoalSmashers/clean-less e.g.");
        ...
        console.log("  --source-map-map-inline  puts the map (and any less files) into the output less file");
