...
var CleanCSS = module.exports = function CleanCSS(options) {
  ...
  if (options.selectorsMergeMode) {
    console.warn('selectorsMergeMode is deprecated and will be removed in clean-less 2.2. Please use compatibility: \'%s\' option instead.', options.selectorsMergeMode);
