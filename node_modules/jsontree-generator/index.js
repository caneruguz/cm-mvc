...
module.exports =  function outputJSON (totalItems, totalLevels){
    ...
    var stream = through.obj(function(file, enc, callback) {
        ...
        */
        ...
        var buildJSON = function redo (level){
            var childarray = [];
            var iteration = totalItems;
            for(var i  = 0; i < iteration; i++){
                //if(items < totalItems){
                    var thisObj = new obj();
                    thisObj.id = iterID;
                    thisObj.level = 1; //totalLevels-level+1;
                    iterID++;
                    //if( level > 0) {
        ...
        buildJSON(1); 
        var outputBuffer = new Buffer(JSON.stringify(outputArray));
        if (file.isNull()) {
