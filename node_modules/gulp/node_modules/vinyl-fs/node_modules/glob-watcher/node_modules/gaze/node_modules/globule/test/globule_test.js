...
exports['find'] = {
  ...
  'basic matching': function(test) {
    ...
    test.deepEqual(globule.find('**/*.js', '**/*.css'),
      ['js/bar.js', 'js/foo.js', 'less/baz.css', 'less/qux.css'],
  ...
  'file order': function(test) {
    test.expect(5);
    var actual = globule.find('**/*.{js,less}');
    var expected = ['less/baz.css', 'less/qux.css', 'js/bar.js', 'js/foo.js'];
    test.deepEqual(actual, expected, 'should select 4 files in this order, by default.');

    actual = globule.find('js/foo.js', 'js/bar.js', '**/*.{js,less}');
    expected = ['js/foo.js', 'js/bar.js', 'less/baz.css', 'less/qux.css'];
    test.deepEqual(actual, expected, 'specifically-specified-up-front file order should be maintained.');

    actual = globule.find('js/bar.js', 'js/foo.js', '**/*.{js,less}');
    expected = ['js/bar.js', 'js/foo.js', 'less/baz.css', 'less/qux.css'];
    test.deepEqual(actual, expected, 'specifically-specified-up-front file order should be maintained.');

    actual = globule.find('**/*.{js,less}', '!less/qux.css', 'less/qux.css');
    expected = ['less/baz.css', 'js/bar.js', 'js/foo.js', 'less/qux.css'];
    test.deepEqual(actual, expected, 'if a file is excluded and then re-added, it should be added at the end.');

    actual = globule.find('js/foo.js', '**/*.{js,less}', '!less/qux.css', 'less/qux.css');
    expected = ['js/foo.js', 'less/baz.css', 'js/bar.js', 'less/qux.css'];
  ...
  'exclusion': function(test) {
    ...
    test.deepEqual(globule.find(['!js/foo.js', '**/*.js']),
      ['js/bar.js', 'js/foo.js'],
      'inclusion / exclusion order matters');
    test.deepEqual(globule.find(['**/*.js', '**/*.css', '!js/bar.js', '!less/baz.css']),
      ['js/foo.js','less/qux.css'],
    ...
    test.deepEqual(globule.find(['js/bar.js', 'js/foo.js', 'less/baz.css', 'less/qux.css', '!**/b*.*']),
      ['js/foo.js', 'less/qux.css'],
      'different pattern for exclusion should still work');
    test.deepEqual(globule.find(['js/bar.js', '!**/b*.*', 'js/foo.js', 'less/baz.css', 'less/qux.css']),
      ['js/foo.js', 'less/baz.css', 'less/qux.css'],
      'inclusion / exclusion order matters');
    test.done();
  },
